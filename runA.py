...
async def gyro_follow_angle_for_distance(angle, distance_to_cover):
    ...
    while (distance_covered < distance_to_cover):
        ...
        print("BEFORE motion_sensor.tilt_angles=", motion_sensor.tilt_angles()[0])
        ...
        motion_sensor.reset_yaw(0)
        print("motion_sensor.tilt_angles=", motion_sensor.tilt_angles()[0])
...
async def main():
    ...
    await gyro_follow_angle_for_distance(0, 1000)
